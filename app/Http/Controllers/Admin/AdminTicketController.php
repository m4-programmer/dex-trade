...
class AdminTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['tickets'] = Ticket::with('ticketReplies')->paginate();
        $data['tickets_pending'] = Ticket::whereStatus('2')->count();
        $data['tickets_answered'] = Ticket::whereStatus('3')->count();
        $data['tickets_closed'] = Ticket::whereStatus('1')->count();
        $data['tickets_all'] = Ticket::count();

        return view($this->template.'ticket.list')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view($this->template.'ticket.add')->with($data);
    }
    ...
    public function show($id)
    {
        ...
        return view($this->template.'ticket.show')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        return view($this->template.'ticket.edit')->with($data);
    }
    ...
    public function statusChange($id)
    {
        ...
        return redirect()->route('ticket.index')->with('success', 'Closed conversation Successfully');
    }
