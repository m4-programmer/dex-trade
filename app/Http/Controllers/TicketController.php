...
class TicketController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->has('file')) {
            ...
            $image = 'asset/theme2/images/Ticket/'.time().'.'.$file->getClientOriginalExtension();
            $file->move('asset/theme2/images/Ticket/', $image);
