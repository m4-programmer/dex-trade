   ...
   <section id="about" class="about-section s-pt-100 s-pb-100 section-bg">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-12">
                <h2 class="section-title">Rules & Agreements.</h2>
                <p>Please read the following rules carefully before signing in.</p>
                <p>You agree to be of legal age in your country to partake in this program, and in all the cases your minimal age must be 18 years.
                </p>
                <p class="text-white text-justifys descripton-root">
                   {{$gs->sitename}} is not available to the general public and is opened only to the qualified members of {{$gs->sitename}}, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the {{$gs->sitename}} and its Member.
                </p>
                <p>
                ...
                <p>
                    You agree that all information, communications, materials coming from {{$gs->sitename}} are unsolicited and must be kept private, confidential and protected from any disclosure. Moreover, the information, communications and materials contained herein are not to be regarded as an offer, nor a solicitation for investments in any jurisdiction which deems non-public offers or solicitations unlawful, nor to any person to whom it will be unlawful to make such offer or solicitation.
                </p>
                <p>
                    All the data giving by a member to {{$gs->sitename}} will be only privately used and not disclosed to any third parties. {{$gs->sitename}} is not responsible or liable for any loss of data.
                </p>
                <p>
                ...
                <p>
                    {{$gs->sitename}} reserves the right to accept or decline any member for membership without explanation.
                </p>
                <p>
