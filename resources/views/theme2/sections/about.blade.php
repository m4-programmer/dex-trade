    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <p class="text-white text-justifys descripton-root">{{translate('
                    ...
                    Dex-trade.cc has managed to build a few large mining farms in United State, Belize, Venezuela and England United Kingdom, We have equipped them with the most powerful and modern mining hardware that around the clock provides excellent results and serves as a source for earnings. Our team consists of professional financial analysts and experts, miners and traders, who are constantly monitoring situations, which may affect a value of one or another cryptocurrency. They estimates the best possible trade entry points on the cryptocurrency market based on ...
                ')}}
                </p>
