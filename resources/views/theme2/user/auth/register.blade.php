                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ old('name') }}" id="first_name" placeholder="{{ __('Your Full Name')}}">
                            </div>
                            <div class="col-md-6">
                                <label for="username">{{ __('Username')}}</label>
                                <input type="text" class="form-control" name="username" value="{{ old('username') }}" id="username" placeholder="{{ __('UserName')}}">
                            </div>
                            ...
                            @if (isset($_GET['ref']))
                            <div class="col-md-12">
                                <label for="formGroupExampleInput"> {{ __('Refferal ID')}}</label>
                                <input type="text" class="form-control" name="referral_id" id="referral_id" placeholder="{{ __('Enter Refferal ID')}}" value="<?php echo @$_GET['ref'] ?>" readonly>
                            </div>
                            @endif
                            <div class="col-md-6">
